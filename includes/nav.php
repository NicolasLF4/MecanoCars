        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                if (isset($_SESSION['nombre_usuario'])) {
                    ...
                    echo "<li><a class='dropdown-item' href='../MecanoCars/descargar.php'>Descargar</a></li>";
                    echo "<li><a class='dropdown-item' href='../MecanoCars/estadisticas.php'>Estadisticas</a></li>";
